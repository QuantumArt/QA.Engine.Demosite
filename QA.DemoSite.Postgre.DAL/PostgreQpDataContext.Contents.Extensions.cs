...
namespace QA.DemoSite.Postgre.DAL
{
    ...
    public partial class QPDiscriminator: IQPArticle
    {
		...
		{ 
			get { return PostgreQpDataContext.Current.GetUrl(this.IconUrl, "QPDiscriminator", "IconUrl"); }
		}
        public string IconUrlUploadPath 
		{ 
			get { return PostgreQpDataContext.Current.GetUploadPath(this.IconUrl, "QPDiscriminator", "IconUrl"); }
		}
    ...
    public partial class QPCulture: IQPArticle
    {
		...
		{ 
			get { return PostgreQpDataContext.Current.GetUrl(this.Icon, "QPCulture", "Icon"); }
		}
        public string IconUploadPath 
		{ 
			get { return PostgreQpDataContext.Current.GetUploadPath(this.Icon, "QPCulture", "Icon"); }
		}
        #endregion
    ...
    public partial class BlogPost: IQPArticle
    {
		...
		{ 
			get { return PostgreQpDataContext.Current.GetUrl(this.Image, "BlogPost", "Image"); }
		}
        public string ImageUploadPath 
		{ 
			get { return PostgreQpDataContext.Current.GetUploadPath(this.Image, "BlogPost", "Image"); }
		}
        #endregion
